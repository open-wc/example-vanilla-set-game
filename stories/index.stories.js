...
storiesOf('Set Game', module)
  .add(
    ...
    () => html`
      ...
      <p>
        ...
        <a href="http://open-wc.org" target="_blank">open-wc</a> has to offer
      </p>
      <p>
  ...
  .add(
    ...
    () => html`
      ...
      <p>
        A set consists of <strong>3</strong> cards and each of the properties for itself needs to be
        <strong>either</strong> the same or different
      </p>
